...
function ProjectList() {
    ...
    <div className="projects-list">
        <ProjectListEl projectName="Hotels app project frontend" projectUrl="https://hotels.ytq.pl" projectRepositoryUrls={{"repository-frontend":"https://github.com/RPwoj/hotels-app-front", "repository-backend":"https://github.com/RPwoj/hotels-api"}} projectTechStack={['Symfony', 'Api Platform', 'React.js','Bootstrap']} />
